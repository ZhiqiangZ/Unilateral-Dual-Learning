...
if __name__ == '__main__':
    ...
    paths = ["",""]
    paths[0] = "/Disk5/zzq/DM-GAN_MirrorGAN/data/flowers/flowers_jpg/jpg"
    #paths[0] = "/Disk5/zzq/DM-GAN_MirrorGAN/data/birds/CUB_200_2011/images"
    paths[1] = "/Disk5/zzq/DM-GAN_MirrorGAN/models/ksem/flower/netG_epoch_600"
    print(paths)
